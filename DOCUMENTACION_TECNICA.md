...
- Detecta inconsistencias donde NIT end1 ≠ NIT end2

✅ **Procesamiento de Datos**
- Enriquece inconsistencias con información adicional
- Identifica relaciones Foreign Object (FO)
...
| `validar_nit_en_relaciones_invertidas()` | `json_data` | `inconsistencias_normales` |

#### Validación de NITs:

**Inconsistencias Normales:**
- NIT end1 ≠ NIT end2
- Ambos campos tienen valores válidos pero diferentes
...
| `enriquecer_inconsistencias_normales()` | `inconsistencias, relations` | `List[Dict]` | Agrega contexto FO |
...
```python
{
    ...
    "end1Id": "string",
    "end2Id": "string",
    "display_label_end1": "string",
    "display_label_end2": "string",
    "nit_end1": "string",           # Campo clr_onyxdb_company_nit
    "nit_end2": "string",           # Campo clr_onyxdb_companynit
    "relacion_fo": bool,             # Indica si tiene relación FO
    "ucmdbid_fo": "string",         # ID de la relación FO (si aplica)
